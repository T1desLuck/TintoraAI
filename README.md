...
## 📚 Содержание: [✨ Особенности](#-особенности) • [🚀 Быстрый старт](#-быстрый-старт) • [📖 Документация](#-документация) • [🧠 Архитектура системы](#-архитектура-системы) • [Поток весов при инференсе (base/adapter/LoRA)](#поток-весов-при-инференсе-baseadapterlora) • [🛠️ Конфигурация](#️-конфигурация) • [Adapter / LoRA (новые возможности)](#adapter--lora-новые-возможности) • [🖼️ Примеры результатов](#️-примеры-результатов) • [🔧 Требования](#-требования) • [⚙️ Как внести вклад](#️-как-внести-вклад) • [🧪 Тесты](#-тесты) • [📄 Лицензия](#-лицензия) • [📜 Цитирование](#-цитирование) • [📞 Контакты](#-контакты)

## 🔗 Быстрые ссылки: [`INSTALL.md`](INSTALL.md) • [`TRAINING.md`](TRAINING.md) • [`CONFIGURATION.md`](CONFIGURATION.md) • [`TEST.md`](TEST.md)
...
│  ├─ bw.jpg
│  └─ color.jpg
├─ vast/                          # Скрипты/утилиты для облачных/remote окружений
│  └─ setup.sh
