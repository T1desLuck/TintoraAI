...
def main():
    ...
    p_infer.add_argument("--input", type=str, required=False, help="Путь к входному изображению")
    p_infer.add_argument("--checkpoint", type=str, default=str(PROJ_ROOT / "checkpoints" / "latest.pth"))
    ...
    if args.command == "train":
        ...
        # Формируем argv для src.inference.main
        argv = ["src.inference"]
        if args.input:
